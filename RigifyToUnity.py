...
nonDeleteBones = ['jaw_master','master_eye.L','master_eye.R','teeth.T','teeth.B'] #These bones not deleted. e.g. 'DEF-eye_L', 'DEF-eye_R'
...
respectDeformStateBones = [ # bone name, parent bone, connected (this is mainly for Constrant of PhysicsAsset)
          ['master_eye.L', 'DEF-spine.006', False],
          ['master_eye.R', 'DEF-spine.006', False],
          ['MCH-eye.L', 'master_eye.L', False],
          ['MCH-eye.R', 'master_eye.R', False],
          ['MCH-eye.L.001', 'MCH-eye.L', True],
          ['MCH-eye.R.001', 'MCH-eye.R', True],
          ['jaw_master', 'DEF-spine.006', False],
          ['teeth.T',   'DEF-spine.006', False],
          ['teeth.B',   'jaw_master', False],
